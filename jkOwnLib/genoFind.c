...
static void gfHitSort2(struct gfHit **ptArray, int n,
                       struct gfHit ***nosTemp, struct gfHit **nosSwap);
 ...
 * that is being sorted. */
{
    ...
    if (n1 > 2)
        gfHitSort2(pt1, n1, nosTemp, nosSwap);
    ...
    if (n2 > 2)
        gfHitSort2(pt2, n2, nosTemp, nosSwap);
